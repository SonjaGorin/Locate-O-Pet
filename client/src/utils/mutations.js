...
mutation addUser($name: String!, $email: String!, $password: String!, $role: String!, $phoneNumber: String!) {
  addUser(name: $name, email: $email, password: $password, role: $role, phoneNumber: $phoneNumber) {
    token
    user {
      ... on User {
        email
